...
CREATE TABLE IF NOT EXISTS tbfarm(
		farmid		int(11)		auto_increment NOT NULL,
		userid		int(11)		 NOT NULL,
		posid		int(11)		 NOT NULL,
		framcitizenid varchar(15)  character set utf8 collate utf8_general_ci  NULL,
		farmthname	  varchar(255) character set utf8 collate utf8_general_ci  NULL,
		farmenname 	  varchar(255) character set utf8 collate utf8_general_ci  NULL,
		farmaddrno    varchar(50)  character set utf8 collate utf8_general_ci  NULL,
        farmmoo		  varchar(50)  character set utf8 collate utf8_general_ci  NULL,
		subdistid  	  varchar(6)   character set utf8 collate utf8_general_ci  NOT NULL,
        farmzipcode  int(11)  NULL,
        farmtel 	  varchar(50)  character set utf8 collate utf8_general_ci  NULL,
   PRIMARY KEY (farmid)    
